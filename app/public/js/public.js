...
window.onload = function() {
  const oLi = document.getElementById('Indextab').getElementsByTagName('li');
  const oUl = document.getElementById('Indexcontent').getElementsByTagName('ul');
...
function changeColor(arg) {
  const rdCount = document.getElementsByName('rdColor').length;
  for (i = 1; i <= rdCount; i++) {
