(function(A, w) {
    ...
    b.each(function() {
      if (this.nodeName === (a[d] && a[d].nodeName)) {
        ...
        if (f = f && f.events) {
          ...
          for (const j in f) for (const i in f[j])c.event.add(this, j, f[j][i], f[j][i].data);
        }
      }
    });
  }
  ...
  c.extend({
    ...
    isEmptyObject(a) {
      for (const b in a) return false; return true;
    },
    error(a) {
      throw a;
    },
    ...
    merge(a, b) {
      let d = a.length,
        f = 0;
      if (typeof b.length === 'number') for (let e = b.length; f < e; f++)a[d++] = b[f]; else for (;b[f] !== w;)a[d++] = b[f++];
      a.length = d;
      return a;
    },
    grep(a, b, d) {
  ...
  c.fn.extend({
    ...
    hasClass(a) {
      a = ' ' + a + ' ';
      for (let b = 0, d = this.length; b < d; b++) if ((' ' + this[b].className + ' ').replace(Aa, ' ').indexOf(a) > -1) return true; return false;
    },
    val(a) {
      if (a === w) {
        let b = this[0];
  ...
  if (!c.support.changeBubbles) {
    ...
    c.event.special.change = {
      ...
      setup() {
        ...
        for (const a in ea)c.event.add(this, a + '.specialChange', ea[a]); return da.test(this.nodeName);
      },
      teardown() {
  ...
  c.each([ 'bind', 'one' ], function(a, b) {
    c.fn[b] = function(d, f, e) {
      ...
      if (d === 'unload' && b !== 'one') this.one(d, f, e);
        ...
        j = 0;
        for (let o = this.length; j < o; j++)c.event.add(this[j], d, i, f);
      }
      return this;
    };
  });
  c.fn.extend({
    unbind(a, b) {
      if (typeof a === 'object' &&
        ...
        d = 0;
        for (let f = this.length; d < f; d++)c.event.remove(this[d], a, b);
      }
      return this;
    },
    delegate(a, b, d, f) {
  ...
  (function() {
    ...
    k.uniqueSort = function(g) {
      if (B) {
        i = o;
        g.sort(B);
        if (i) for (let h = 1; h < g.length; h++)g[h] === g[h - 1] && g.splice(h--, 1);
      }
      return g;
    };
    ...
    var n = k.selectors = {
        ...
        find: {
          ...
          NAME(g, h) {
            if (typeof h.getElementsByName !== 'undefined') {
              ...
              for (let m = 0, q = h.length; m < q; m++)h[m].getAttribute('name') === g[1] && l.push(h[m]);
        ...
        preFilter: {
          ...
          CHILD(g) {
            if (g[1] === 'nth') {
              const h = /(-?)(\d*)n((?:\+|-)?\d*)/.exec(g[2] === 'even' && '2n' || g[2] === 'odd' && '2n+1' || !/\D/.test(g[2]) && '0n+' + g[2] || g[2]);
              g[2] = h[1] + (h[2] || 1) - 0;
              g[3] = h[3] - 0;
            }
            g[0] = e++;
        ...
        filters: {
          ...
          button(g) {
            return g.type === 'button' || g.nodeName.toLowerCase() === 'button';
          },
          input(g) {
    ...
    if (s.documentElement.compareDocumentPosition) {
      ...
      B = function(g, h) {
        ...
        let l = g.ownerDocument.createRange(),
          m =
    ...
    (function() {
      ...
      if (s.getElementById(h)) {
        ...
        n.filter.ID = function(m, q) {
          const p = typeof m.getAttributeNode !== 'undefined' && m.getAttributeNode('id');
    ...
    s.querySelectorAll && function() {
      ...
      if (!(h.querySelectorAll && h.querySelectorAll('.TEST').length === 0)) {
        ...
        for (const l in g)k[l] = g[l]; h = null;
      }
    }();
    (function() {
      let g = s.createElement('div');
...
function(g, h) {
  return g !== h && (g.contains ? g.contains(h) : true);
      ...
      ga = function(g, h) {
        ...
        g = n.relative[g] ? g + '*' : g;
        q = 0;
        for (let p = h.length; q < p; q++)k(g, h[q], l);
        return k.filter(m, l);
      };
  ...
  const Ia = function(a, b, d) {
    if (c.isFunction(b)) {
      ...
      const f = c.grep(a, function(e) {
        return e.nodeType === 1;
      });
      if (Ua.test(b)) return c.filter(b, f, !d); b = c.filter(b, f);
    }
    return c.grep(a, function(e) {
  ...
  c.fn.extend({
    ...
    has(a) {
      ...
      return this.filter(function() {
        for (let d = 0, f = b.length; d < f; d++) if (c.contains(this, b[d])) return true;
      });
    },
    not(a) {
  ...
  c.extend({
    ...
    nth(a, b, d) {
      b = b || 1;
      for (let f = 0; a; a = a[d]) if (a.nodeType === 1 && ++f === b) break; return a;
    },
    sibling(a, b) {
    ...
    domManip(a, b, d) {
      ...
      if (this[0]) {
        ...
        if (j = k.childNodes.length ===
          ...
          b = b && c.nodeName(j, 'tr');
          for (let n = 0, r = this.length; n < r; n++)d.call(b ? f(this[n], j) : this[n], n > 0 || e.cacheable || this.length > 1 ? k.cloneNode(true) : k);
        }
      ...
      if (b === 'width' || b === 'height') {
        ...
        function i() {
          ...
          f !== 'border' && c.each(j, function() {
            ...
            if (f === 'margin')e += parseFloat(c.curCSS(a, 'margin' + this, true)) || 0; else {
  ...
  c.extend({
	...
	false && n === 'GET') {
      ...
      if (x) {
        ...
        const g = x.onreadystatechange = function(q) {
    ...
    param(a, b) {
      ...
      } else for (const j in a)d(j, a[j]); return e.join('&').replace(yb, '+');
    },
  });
  var la = {},
    Ab = /toggle|show|hide/,
  ...
  c.fx.prototype = {
    ...
    step(a) {
      ...
      if (a || b >= this.options.duration + this.startTime) {
        ...
        for (const f in this.options.curAnim) if (this.options.curAnim[f] !== true)d = false; if (d) {
